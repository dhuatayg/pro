            ...
            <form action="<?php echo base_url();?>mantenimiento/clientes/update" method="POST">  
                ...
                <div class="box-body">
                    <div class="row">                                            
                        ...
                        <div class="col-md-12">
                            <input type="hidden" value="<?php echo $cliente->id_cliente;?>" id="id_cliente" name="id_cliente">
                            <div class="form-group <?php echo form_error('ndocumento_cliente') == true ? 'has-error':''?>">                            
                                ...
                                <input type="text" class="form-control" id="ndocumento_cliente" name="ndocumento_cliente" value="<?php echo $cliente->ndocumento_cliente;?>"> 
                        ...
                        <div class="form-group <?php echo form_error('correo_cliente') == true ? 'has-error':''?>">
                                ...
                                <input type="text" class="form-control" id="correo_cliente" name="correo_cliente" value="<?php echo $cliente->correo_cliente;?>">
