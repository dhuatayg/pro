...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
        Reporte
        <small>Nivel de Productividad</small>
        </h1>
        <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i>Inicio</a></li>
        <li><i class="fa fa-print"></i> Reporte</li>
        <li><i class="active"></i>Nivel de Productividad</li>
      </ol>
    </section>
            ...
            <div class="box-header with-border">
                <div class="row">
                    <div class="form-group">
                        ...
                        <!-- Buscar -->
                        <div class="col-md-1">
                            <label for="busqueda_productividad" style="color:#FFFFFF;">_</label> 
                            <button type="button" id="busqueda_productividad" class="btn btn-default btn-flat">Buscar</button>
                        </div>
                    </div>
                </div>
            </div>
