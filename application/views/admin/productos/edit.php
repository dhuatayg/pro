...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-success">
            <!-- Formulario -->
            <form action="<?php echo base_url();?>rev/productos/update" method="POST">  
                <!-- Header -->
                    ...
                    <div class="row">                                            
                        ...
                        <div class="col-md-2">
                            <div class="form-group"> 
                                ...
                                <input type="text" class="form-control" id="abre_producto" name="abre_producto" 
                                value="<?php echo $producto->abre_producto?>" readonly="readonly">
                            </div>
                        </div>
                        <!-- Nombre de Producto -->
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            <div class="form-group <?php echo form_error('stock_producto') == true ? 'has-error':''?>">
                                ...
                                <input type="text" class="form-control" id="stock_producto" name="stock_producto" value="<?php echo $producto->stock_producto?>">
                        ...
                        <div class="col-md-2">
                            <div class="form-group <?php echo form_error('precio_producto') == true ? 'has-error':''?>">
                                ...
                                <input type="text" class="form-control" id="precio_producto" name="precio_producto" value="<?php echo $producto->precio_producto?>">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="input-group <?php echo form_error('id_material') == true ? 'has-error':''?>">
                                                        ...
                                                        <button type="button" id="btn-añadir-material" class="btn btn-success btn-flat">Agregar</button>
                                                        </span>
                                        ...
                                        <table id="tb_material" class="table table-bordered table-striped table-hover">
                                            ...
                                            <tbody>
                                            <?php if(!empty($prmateriales)):?>
                                                <?php foreach($prmateriales as $material):?>
                                                    <tr>
                                                        <td class="text-center" for="id" style="display:none;"><?php echo $material->id;?></td>
                                                        <td class="text-center"><input type="hidden" name="id_material[]" value="<?php echo $material->id;?>"><?php echo $material->cod;?></td>                                                  
                                                        <td class="text-center"><?php echo $material->nom;?></td>
                                                        <td class="text-center"><?php echo $material->des;?></td>
                                                        <td class="text-center"><?php echo $material->uni;?></td>
                                                        <td class='text-center'><input type="text" name="cantidad_maproducto[]" value="<?php echo $material->nec;?>" class="cantidades"></td>
                                    ...
                                    <div class="tab-pane" id="tab_2">
                                        ...
                                        <table id="tb_maquina" class="table table-bordered table-striped table-hover">
                                            ...
                                            <tbody>
                                            <?php if(!empty($prmaquinas)):?>
                                                <?php foreach($prmaquinas as $maquina):?>
                                                    <tr>
                                                        <td class="text-center" for="id" style="display:none;"><?php echo $maquina->num;?></td>
                                                        <td class="text-center"><input type="hidden" name="id_maquina[]" value="<?php echo $maquina->num;?>"><?php echo $maquina->cod;?></td>                                                  
